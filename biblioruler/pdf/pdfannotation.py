...
def highlight_annotation(
    ...
    rect = [
        min(quadpoints_col(0)),
        min(quadpoints_col(1)),
        max(quadpoints_col(2)),
        max(quadpoints_col(3)),
    ]

    retval = _markup_annotation(
        rect, contents, author, subject, cdate, color, alpha, flag
    )
...
if __name__ == "__main__":
    ...
    annot2 = text_annotation(
        [100, 50, 125, 75], "No it isn't.", "John Cleese", "No you didn't."
    )
